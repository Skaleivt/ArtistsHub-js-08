import{a as L}from"./assets/vendor-BvLu_gPC.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const t of e)if(t.type==="childList")for(const r of t.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function a(e){const t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?t.credentials="include":e.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function o(e){if(e.ep)return;e.ep=!0;const t=a(e);fetch(e.href,t)}})();const k="/ArtistsHub-js-08/assets/symbol-defs-DNVN9KjG.svg",u=document.getElementById("artist-modal"),w=document.getElementById("artist-modal-close"),C=document.getElementById("modal-loader");function A(){C.classList.remove("hidden")}function M(){C.classList.add("hidden")}function $(s){s.target===u&&f()}function B(s){s.key==="Escape"&&f()}function H(){u.classList.add("is-open"),document.body.style.overflow="hidden",w.addEventListener("click",f),u.addEventListener("click",$),document.addEventListener("keydown",B)}function f(){u.classList.remove("is-open"),document.body.style.overflow="",w.removeEventListener("click",f),u.removeEventListener("click",$),document.removeEventListener("keydown",B)}async function P(s){A();try{const n=await s;document.getElementById("artist-name").textContent=n.strArtist||"Unknown",document.getElementById("artist-years").textContent=n.intFormedYear?`${n.intFormedYear}–${n.intDiedYear||"present"}`:"information missing",document.getElementById("artist-sex").textContent=n.strGender||"N/A",document.getElementById("artist-members").textContent=n.intMembers||"N/A",document.getElementById("artist-country").textContent=n.strCountry||"N/A",document.getElementById("artist-bio").textContent=n.strBiographyEN||"No biography available.",document.getElementById("artist-image").src=n.strArtistThumb;const a=document.getElementById("artist-genres");if(a.innerHTML="",Array.isArray(n.genres)&&n.genres.length>0)n.genres.forEach(e=>{const t=document.createElement("span");t.className="genre-item",t.textContent=e,a.appendChild(t)});else{const e=document.createElement("span");e.className="genre-item",e.textContent="Unknown genre",a.appendChild(e)}const o=document.getElementById("albums-container");if(o.innerHTML="",Array.isArray(n.tracksList)&&n.tracksList.length>0){const e={};n.tracksList.forEach(t=>{const r=t.strAlbum||"Unknown Album";e[r]||(e[r]=[]),e[r].push(t)}),Object.entries(e).forEach(([t,r])=>{const i=document.createElement("li");i.className="album";const c=document.createElement("h2");c.className="album-title",c.textContent=t;const d=document.createElement("div");d.className="track-list-container";const g=document.createElement("div");g.className="track-header",g.innerHTML=`
    ...
    `;const h=document.createElement("ul");h.className="track-list",r.forEach(m=>{const T=m.strTrackName||m.strTrack||"Unknown track",b=m.intDuration;function q(U){const E=Math.floor(Number(U)/1e3),_=Math.floor(E/60),D=E%60;return`${_}:${D.toString().padStart(2,"0")}`}const j=b?q(b):"Unknown length",v=m.movie,y=document.createElement("li");y.className="track-item",y.innerHTML=`
      ...
      `,h.appendChild(y)}),d.appendChild(g),d.appendChild(h),i.appendChild(c),i.appendChild(d),o.appendChild(i)})}else{const e=document.createElement("p");e.className="no-albums",e.textContent="No tracks available.",o.appendChild(e)}H()}catch(n){console.error("Error loading artist:",n)}finally{M()}}const N="https://sound-wave.b.goit.study/api";async function F(s=1,n=8){try{return(await L.get(`${N}/artists`,{params:{page:s,limit:n}})).data}catch{return iziToast.error({message:"Sorry, there is no more artists. Please try later!",position:"topRight",messageColor:"#fff",messageSize:"16px",backgroundColor:" #EF4040",timeout:3e3}),{}}}async function O(s=1,n=25){try{return(await L.get(`${N}/feedbacks`,{params:{page:s,limit:n}})).data.data}catch(a){return console.error("API Error:",a),{}}}const R="/ArtistsHub-js-08/assets/placeholder-CaZEGydM.jpg",x=document.querySelector(".artists-list"),p=document.querySelector("#load-more-btn");let I=1;const z=8;async function S(){p.style.display="none",A();try{const s=await F(I,z);if(s.artists.length===0){p.style.display="none",iziToast.info({title:"Notice",message:"No more artists to load",position:"bottomRight",messageColor:"#fff",messageSize:"16px",backgroundColor:" #EF4040",timeout:3e3});return}G(s.artists,k),p.style.display="flex"}catch(s){console.error("Failed to load artists:",s)}finally{M()}}function G(s,n){const o=s.filter(e=>e._id).map(e=>{var i;const t=(i=e.genres)!=null&&i.length?e.genres.map(c=>`<span class="artist-card-genre">${c}</span>`).join(""):'<span class="artist-card-genre">Unknown</span>',r=e.strArtistThumb||R;return`
