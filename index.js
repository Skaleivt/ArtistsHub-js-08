import{a as L}from"./assets/vendor-BvLu_gPC.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))o(t);new MutationObserver(t=>{for(const e of t)if(e.type==="childList")for(const r of e.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function a(t){const e={};return t.integrity&&(e.integrity=t.integrity),t.referrerPolicy&&(e.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?e.credentials="include":t.crossOrigin==="anonymous"?e.credentials="omit":e.credentials="same-origin",e}function o(t){if(t.ep)return;t.ep=!0;const e=a(t);fetch(t.href,e)}})();const k="/ArtistsHub-js-08/assets/symbol-defs-DNVN9KjG.svg",m=document.getElementById("artist-modal"),w=document.getElementById("artist-modal-close"),C=document.getElementById("modal-loader");function A(){C.classList.remove("hidden")}function M(){C.classList.add("hidden")}function $(s){s.target===m&&g()}function B(s){s.key==="Escape"&&g()}function H(){m.classList.add("is-open"),document.body.style.overflow="hidden",w.addEventListener("click",g),m.addEventListener("click",$),document.addEventListener("keydown",B)}function g(){m.classList.remove("is-open"),document.body.style.overflow="",w.removeEventListener("click",g),m.removeEventListener("click",$),document.removeEventListener("keydown",B)}async function P(s){A();try{const n=await s;document.getElementById("artist-name").textContent=n.strArtist||"Unknown",document.getElementById("artist-years").textContent=n.intFormedYear?`${n.intFormedYear}–${n.intDiedYear||"present"}`:"information missing",document.getElementById("artist-sex").textContent=n.strGender||"N/A",document.getElementById("artist-members").textContent=n.intMembers||"N/A",document.getElementById("artist-country").textContent=n.strCountry||"N/A",document.getElementById("artist-bio").textContent=n.strBiographyEN||"No biography available.",document.getElementById("artist-image").src=n.strArtistThumb;const a=document.getElementById("artist-genres");if(a.innerHTML="",Array.isArray(n.genres)&&n.genres.length>0)n.genres.forEach(t=>{const e=document.createElement("span");e.className="genre-item",e.textContent=t,a.appendChild(e)});else{const t=document.createElement("span");t.className="genre-item",t.textContent="Unknown genre",a.appendChild(t)}const o=document.getElementById("albums-container");if(o.innerHTML="",Array.isArray(n.tracksList)&&n.tracksList.length>0){const t={};n.tracksList.forEach(e=>{const r=e.strAlbum||"Unknown Album";t[r]||(t[r]=[]),t[r].push(e)}),Object.entries(t).forEach(([e,r])=>{const i=document.createElement("li");i.className="album";const c=document.createElement("h2");c.className="album-title",c.textContent=e;const l=document.createElement("div");l.className="track-list-container";const u=document.createElement("div");u.className="track-header",u.innerHTML=`
      <span>Track</span>
      <span>Time</span>
      <span>Link</span>
    `;const h=document.createElement("ul");h.className="track-list",r.forEach(p=>{const T=p.strTrackName||p.strTrack||"Unknown track",b=p.intDuration;function q(U){const E=Math.floor(Number(U)/1e3),_=Math.floor(E/60),D=E%60;return`${_}:${D.toString().padStart(2,"0")}`}const j=b?q(b):"Unknown length",v=p.movie,y=document.createElement("li");y.className="track-item",y.innerHTML=`
      ...
      `,h.appendChild(y)}),l.appendChild(u),l.appendChild(h),i.appendChild(c),i.appendChild(l),o.appendChild(i)})}else{const t=document.createElement("p");t.className="no-albums",t.textContent="No tracks available.",o.appendChild(t)}H()}catch(n){console.error("Error loading artist:",n)}finally{M()}}const N="https://sound-wave.b.goit.study/api";async function F(s=1,n=8){try{return(await L.get(`${N}/artists`,{params:{page:s,limit:n}})).data}catch{return iziToast.error({message:"Sorry, there is no more artists. Please try later!",position:"topRight",messageColor:"#fff",messageSize:"16px",backgroundColor:" #EF4040",timeout:3e3}),{}}}async function O(s=1,n=25){try{return(await L.get(`${N}/feedbacks`,{params:{page:s,limit:n}})).data.data}catch(a){return console.error("API Error:",a),{}}}const R="/ArtistsHub-js-08/assets/placeholder-CaZEGydM.jpg",x=document.querySelector(".artists-list"),f=document.querySelector("#load-more-btn");let I=1;const z=8;async function S(){f.style.display="none",A();try{const s=await F(I,z);if(s.artists.length===0){f.style.display="none",iziToast.info({title:"Notice",message:"No more artists to load",position:"bottomRight",messageColor:"#fff",messageSize:"16px",backgroundColor:" #EF4040",timeout:3e3});return}G(s.artists,k,R),f.style.display="flex"}catch(s){console.error("Failed to load artists:",s)}finally{M()}}function G(s,n,a){const t=s.filter(e=>e._id).map(e=>{var c,l;const r=(c=e.genres)!=null&&c.length?e.genres.map(u=>`<span class="artist-card-genre">${u}</span>`).join(""):'<span class="artist-card-genre">Unknown</span>',i=(l=e.strArtistThumb)!=null&&l.trim()?e.strArtistThumb.trim():a;return`
